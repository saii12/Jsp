...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> <!-- 라이브러리 빼놓지 않기!! -->
        ...
        <main id="board">
            <section class="list">                
                ...
                <table border="0">
                    ...
                    <c:forEach var="article" items="${articles}"> <!-- 내장객체 생략가능 / for(article : articles){} 랑  같은 표현임!!! -->
	                    <tr>
	                        <td>${pageStartNum = pageStartNum - 1}</td> <!-- pageStartNum을 어떻게 표현?? -->

...
<script>
	$(function(){ //window.onload = function(){ // window.onload는 하나만 실행 가능, checkUser.js 에도 window.onload 있어서 둘 중에 하나만 실행됨.
        ...
        <main id="user">
            <section class="myInfo">
                <form action="/Jboard2/user/myInfo.do" method="post">
                    ...
                    <div>
                        <a href="/Jboard2/user/list.do" class="btn btnCancel">취소</a>

...
<%
	...
	// XML 생성 / jdom 라이브러리의 문법을 보고 이렇게 작성하는 것
	Document doc = new Document(); //Document는 jdom객체
	Element elUsers = new Element("users"); // Element는 jdom객체, 태그생성시 이용 / <users></users>태그생성
	...
	for(User2VO vo : users){
		...
		elAge.setText(""+vo.getAge()); //int -> String : String.valueof 또는 ""+ 이렇게 표현하면됨
		
		elUser.addContent(elUid); // <user></user> 태그 안에 넣기

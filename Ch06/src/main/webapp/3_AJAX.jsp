		...
		<!-- 
		 ...
		 <script>
		 	...
		 	window.onload = function(){
				...
				const btn1 = document.getElementById("btn1"); // alert('준비완료!'); 이렇게 테스트하면서 작성하기
				const spans = document.getElementsByTagName('span');
				
				btn1.onclick = function(){
					
					const xhr = new XMLHttpRequest();		// alert('클릭!');
					...
					} // onreadystatechange end / 중괄호 끝 표시 습관들이기
					...
					fetch('/Ch06/data/json2.jsp')
						...
						.then((data)=>{
							...
							for(let user of data){
								...
								const tr = document.createElement('tr'); // insertAdjentHTML('beforeend', <tr>)도 가능

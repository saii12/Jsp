...
<%
	...
	List<ProductDTO> products = dao.selectProducts(type, start); //DTO를 조절변수로 받는 DAO가 아니므로 DTO 생성할 필요없다.
        ...
        <article class="list">
            ...
            <% for(ProductDTO product : products){ %>
                <tr>
                    ...
                    <td>
                    	<%
                    		switch(product.getType()){
	                    		case 1: out.print("과일"); break; // getType()값이 1이면 과일
                    ...
                    <td><strong><%= product.getPriceWithComma() %></strong>원</td> <!-- strong으로 글씨 진하게 -->
                </tr>
                <% } %>
            </table>

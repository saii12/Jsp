            ...
            <div class="latest">
                <div>
                    ...
                    <% for(ArticleDTO latest : latests1){ %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/board/view.jsp?group=Croptalk&cate=grow&no=<%= latest.getNo()%>"><%= latest.getTitle() %></a></td> <!-- DAO에서 selectLatests 할때 만들어지는 DTO는 no, title, rdate 속성만 가지고 있다. / -->
                ...
                <div>
                    ...
                    <table border="0">
                     <% for(ArticleDTO latest : latests2){ %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/board/view.jsp?group=Croptalk&cate=school&no=<%= latest.getNo()%>"><%= latest.getTitle() %></a></td> <!-- group, cate에는 고정값으로 Croptalk, school 넣음 -->
                            <td><%= latest.getRdate() %></td>
                        </tr>
                        <% } %>
